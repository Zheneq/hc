...
public class AbilityUtil_Targeter_BombingRun : AbilityUtil_Targeter
{
	...
	public override void UpdateTargetingMultiTargets(AbilityTarget currentTarget, ActorData targetingActor, int currentTargetIndex, List<AbilityTarget> targets)
	{
		...
		if (boardSquarePathInfo != null)
		{
			...
			List<ActorData> actors2 = AreaEffectUtils.GetActorsInShape(m_explosionShape, centerOfShape2, centerSquare, false, targetingActor, targetingActor.GetEnemyTeam(), null);
			TargeterUtils.RemoveActorsInvisibleToClient(ref actors2);
