	...
	protected override string ModSpecificAutogenDesc(AbilityData abilityData)
	{
		...
		if (scampDualLasers != null)
		{
			if (m_defaultOnHitDataMod != null)
			{
				...
				text = str + defaultOnHitDataMod.GetInEditorDesc("-- Default On Hit Data Mod --", (OnHitAuthoredData)obj);
				string str2 = text;
				...
				text = str2 + shieldDownOnHitDataMod.GetInEditorDesc("-- Shield Down On Hit Data Mod --", (OnHitAuthoredData)obj2);
