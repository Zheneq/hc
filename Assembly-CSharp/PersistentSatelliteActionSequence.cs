	...
	private void ProcessAction()
	{
		...
		while (true)
		{
			...
			while (true)
			{
				...
				goto IL_0109;
				IL_0109:
				m_lastBoardSquare = Board.Get().GetSquareFromVec3(m_persistentSatellite.transform.position);
				return;
			}
		}
	}
		...
		while (true)
		{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					while (true)
					{
						BoardSquare boardSquare = Board.Get().GetSquareFromVec3(m_persistentSatellite.transform.position);
