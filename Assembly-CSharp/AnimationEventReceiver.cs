...
public class AnimationEventReceiver : MonoBehaviour, IAnimationEvents
{
	...
	internal void ProcessAnimationEvent(UnityEngine.Object eventObject, GameObject sourceObject)
	{
		...
		if (eventObject == null)
		{
			...
			{
				string text = (!(this.GetActorData() == null) && !(this.GetActorData().\u000E() == null)) ? this.GetActorData().\u000E().GetCurrentAnimatorStateName() : "NULL";
				string text2 = (!(this.GetActorData() != null)) ? "UNKNOWN" : this.GetActorData().\u0018();
