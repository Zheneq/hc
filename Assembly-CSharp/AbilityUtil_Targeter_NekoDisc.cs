...
public class AbilityUtil_Targeter_NekoDisc : AbilityUtil_Targeter_Laser
{
	...
	public AbilityUtil_Targeter_NekoDisc(
		Ability ability,
		float width,
		float distance,
	...
	public override void UpdateTargeting(AbilityTarget currentTarget, ActorData targetingActor)
	{
		...
		AddActorsInRange(actors, losCheckPos, targetingActor);
		BoardSquare discEndSquare = NekoBoomerangDisc.GetDiscEndSquare(losCheckPos, laserEndPos);
