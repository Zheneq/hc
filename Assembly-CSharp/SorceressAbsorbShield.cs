...
public class SorceressAbsorbShield : Ability
{
	...
	private void Start()
	{
		base.Targeter = new AbilityUtil_Targeter_Shape(this, m_shape, true, AbilityUtil_Targeter_Shape.DamageOriginType.CenterOfShape, false, true);
	}

	protected override List<AbilityTooltipNumber> CalculateAbilityTooltipNumbers()
	{
		List<AbilityTooltipNumber> list = new List<AbilityTooltipNumber>();
		list.Add(new AbilityTooltipNumber(AbilityTooltipSymbol.Absorb, AbilityTooltipSubject.Primary, m_absorbAmount));
		return list;
	}
